...
<div style="display: flex; align-items: center; padding: 20px; background-color: #f4f4f4; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div>
        ...
        <p>Specializing in Web Development and Programming</p>
    </div>
</div>
Features
...
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 20px;">
    <div style="text-align: center;">
        <img src="SQL.jpg" alt="SQL Certification" width="150" style="border: 2px solid #0d7377; border-radius: 10px;">
        <p>SQL Certification - Sololearn (April 2021)</p>
    </div>
    <div style="text-align: center;">
        <img src="CPlusPlus.jpg" alt="C++ Certification" width="150" style="border: 2px solid #0d7377; border-radius: 10px;">
        <p>C++ Certification - Sololearn (April 2021)</p>
    </div>
    <div style="text-align: center;">
        <img src="HTML.jpg" alt="HTML5 Certification" width="150" style="border: 2px solid #0d7377; border-radius: 10px;">
        <p>HTML5 Application Development - Sololearn (April 2021)</p>
    </div>
    <div style="text-align: center;">
        <img src="JavaScript.jpg" alt="JavaScript Certification" width="150" style="border: 2px solid #0d7377; border-radius: 10px;">
        <p>JavaScript Certification - Sololearn (April 2021)</p>
    </div>
</div>
